...
var me_user1 = setInterval(function () {
  if (myid != null) {
    ...
    $("div#users .uzr:contains('عدن') .My_vedio1").click(function () {
      ...
      $("#movon1").append('<iframe id="ifr_mov1" style="max-width: 340px;min-width: 300px;right: 0; top: 35px; left: auto;" class="modal in" role="dialog" style="z-index: 2100; display: none; style="max-width:240px;" src="https://www.youtube.com/watch?v=zYvh9SjpQNE" allowfullscreen="" width="338" height="490" frameborder="0"></iframe>');
